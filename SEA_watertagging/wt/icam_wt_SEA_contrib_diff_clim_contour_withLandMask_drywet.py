...
outdir = outdir + 'drywet/'+monsoon_period_str+'/py_precent_diff_contour_wtLandMask_10N_20N/'
...
for t in range(0, tagnum):
    localratio_wet[t] = 100.0 * localPrecip_awet[t] / globalPrecip_wet
    print(str(t+5)+': '+str(localratio_wet[t]))
for t in range(0, tagnum):
    localratio_dry[t] = 100.0 * localPrecip_adry[t] / globalPrecip_dry
...
# plt.show()
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_percent_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'.png', bbox_inches='tight', dpi=600)
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_percent_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'.pdf', bbox_inches='tight', dpi=600)
plt.close(fig)
...
cbar.set_label('%', fontsize=7, labelpad=0.7)
# drawMapRect(las, los, m, 'white')
# plt.show()
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_percent_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'_diff.png', bbox_inches='tight', dpi=600)
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_percent_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'_diff.pdf', bbox_inches='tight', dpi=600)
plt.close(fig)
