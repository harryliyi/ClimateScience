...
# plt.show()
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_moist_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'.png', bbox_inches='tight', dpi=600)
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_moist_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'.pdf', bbox_inches='tight', dpi=600)
plt.close(fig)
...
# drawMapRect(las, los, m, 'white')
# plt.show()
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_moist_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'_diff.png', bbox_inches='tight', dpi=600)
plt.savefig(outdir+'icam_SEA_'+str(year1)+'_'+str(year2)+'_moist_contrib_clim_contour_withLandMask_drywet_' + monsoon_period_str+'_diff.pdf', bbox_inches='tight', dpi=600)
plt.close(fig)
