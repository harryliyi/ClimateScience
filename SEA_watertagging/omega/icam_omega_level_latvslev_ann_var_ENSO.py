...
outdir = '/scratch/d/dylan/harryli/gpcdata/Analysis/icam5/SEA_wt_1920today/annual_variability/verticalcirculation/latvslev/'
...
#    ax1.set_yscale('log')
    ...
    if (opt == 1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_with_siglev_"+fname+".pdf")
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_"+fname+".pdf")
...
#    ax1.set_yscale('log')
    ...
    plt.title(titlestr+" JJA "+varstr, fontsize=11, y=1.08)
    if (opt == 1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_vector_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_with_siglev_"+fname+".pdf")
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_vector_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_"+fname+".pdf")
...
#    ax1.set_yscale('log')
    ...
    if (opt == 1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_with_siglev_"+forcingfname+".pdf")
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_"+forcingfname+".pdf")
...
#    ax1.set_yscale('log')
    ...
    plt.title(forcingstr+" "+varstr+" changes", fontsize=11, y=1.08)
    if (opt == 1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_vector_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_with_siglev_"+forcingfname+".pdf")
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_vector_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_"+forcingfname+".pdf")
...
#    ax2.xaxis.set_tick_params(labelsize=6)
    ...
    if (opt == 1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_with_siglev_aerosolsinone.pdf", bbox_inches='tight')
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_aerosolsinone.pdf", bbox_inches='tight')
...
#    ax2.xaxis.set_tick_params(labelsize=6)
    ...
    plt.suptitle("Aerosol Responses "+varstr+" changes", fontsize=10, y=0.95)
    if (opt == 1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_vector_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_with_siglev_aerosolsinone.pdf", bbox_inches='tight')
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_SEA_latvslev_response_vector_"+str(lonbounds[0])+"E_to_"+str(lonbounds[1])+"E_aerosolsinone.pdf", bbox_inches='tight')
