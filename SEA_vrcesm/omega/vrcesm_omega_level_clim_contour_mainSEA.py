...
outdir = '/scratch/d/dylan/harryli/cesm1/vrcesm/Analysis/vrseasia_AMIP_1979_to_2005/VRseasia_vs_ne30andfv09/omega/'

# set up variable names and file name
varname = 'OMEGA'
var_longname = r"$\omega 850$"
varstr = "850hPa_omega"
...
model_var1 = model_var1[:, model_lev1, :, :] * 1000
model_var2 = model_var2[:, model_lev2, :, :] * 1000
model_var3 = model_var3[:, model_lev3, :, :] * 1000
model_var4 = model_var4[:, model_lev4, :, :] * 1000
