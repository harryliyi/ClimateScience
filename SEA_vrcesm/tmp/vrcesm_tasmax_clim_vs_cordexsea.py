...
# calculate monthly mean from daily max/min
# mon_var1 = []
# mon_var2 = []
# mon_var3 = []
# mon_var4 = []
# for idx, imon in enumerate(monthts):
#     select_dates = ((model_time1.year == imon.year) & (model_time1.month == imon.month))
#     mon_var1.append(np.ma.mean(model_var1[select_dates, :, :], axis=0))
#
#     select_dates = ((model_time2.year == imon.year) & (model_time2.month == imon.month))
#     mon_var2.append(np.ma.mean(model_var2[select_dates, :, :], axis=0))
#
#     select_dates = ((model_time3.year == imon.year) & (model_time3.month == imon.month))
#     mon_var3.append(np.ma.mean(model_var3[select_dates, :, :], axis=0))
#
#     select_dates = ((model_time4.year == imon.year) & (model_time4.month == imon.month))
#     mon_var4.append(np.ma.mean(model_var4[select_dates, :, :], axis=0))
#
# model_time1 = monthts
# model_time2 = monthts
# model_time3 = monthts
# model_time4 = monthts
#
# model_var1 = np.ma.array(mon_var1)
# model_var2 = np.ma.array(mon_var2)
# model_var3 = np.ma.array(mon_var3)
# model_var4 = np.ma.array(mon_var4)
