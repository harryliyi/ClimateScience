...
cordex_legends = ['CORDEX-EC-Earth-RegCM4', 'CORDEX-IPSL-CM5A-RegCM4', 'CORDEX-MPI-ESM-RegCM4', 'CORDEX-HadGEM2-ES-RCA4']
...
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_diff_contour_vs_cordex_ref'+projectstr+'_wtsig_inone_a'
...
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_diff_contour_vs_cordex_ref'+projectstr+'_nosig_inone_a'
...
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_var_contour_vs_cordex_ref'+projectstr+'_wtsig_inone_a'
...
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_var_contour_vs_cordex_ref'+projectstr+'_nosig_inone_a'
...
title = str(iniyear)+'-'+str(endyear)+' climatological mean '+varname+' differece (Ref as '+project+')'
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_diff_contour_vs_cordex_ref'+projectstr+'_wtsig_inone_b'

plot_2Dcontour(models_mean_diff, plot_lons, plot_lats, colormap, clevs, clim_labels, lonbounds,
               latbounds, varname, var_unit, title, outdircordex+fname, opt=1, sig_test=models_mean_ttest, ylabel=cordex_legends)

# without significance levels
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_diff_contour_vs_cordex_ref'+projectstr+'_nosig_inone_b'

plot_2Dcontour(models_mean_diff, plot_lons, plot_lats, colormap, clevs, clim_labels, lonbounds,
               latbounds, varname, var_unit, title, outdircordex+fname, opt=0, ylabel=cordex_legends)
...
title = str(iniyear)+'-'+str(endyear)+' climatological mean '+varname+' variability differece (Ref as '+project+')'
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_var_contour_vs_cordex_ref'+projectstr+'_wtsig_inone_b'

plot_2Dcontour(models_std_diff, plot_lons, plot_lats, colormap, clevs, clim_labels, lonbounds,
               latbounds, varname, var_unit, title, outdircordex+fname, opt=1, sig_test=models_std_ftest, sig_thres=2.2693, ylabel=cordex_legends)

# without significance levels
fname = 'vrseasia_'+varstr+'_SEA_clim_mean_var_contour_vs_cordex_ref'+projectstr+'_nosig_inone_b'

plot_2Dcontour(models_std_diff, plot_lons, plot_lats, colormap, clevs, clim_labels, lonbounds,
               latbounds, varname, var_unit, title, outdircordex+fname, opt=0, ylabel=cordex_legends)

############################################################################
# plot climatological difference against GHCN-CAMS
############################################################################
