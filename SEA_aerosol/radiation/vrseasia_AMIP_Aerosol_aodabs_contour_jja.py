...
cs = map.contourf(x,y,var1jja,clevs,cmap=cm.Purples,alpha = 0.9)
# add colorbar.
...
#print(x)
clevs = np.arange(0.,0.5,0.05)
cs = map.contourf(x,y,var2jja,clevs,cmap=cm.Purples,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
##cbar.set_label('K')
# add title
...
#print(x)
clevs = np.arange(0.,0.5,0.05)
cs = map.contourf(x,y,var3jja,clevs,cmap=cm.Purples,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
##cbar.set_label('K')
# add title
...
#print(x)
clevs = np.arange(0.,0.5,0.05)
cs = map.contourf(x,y,var4jja,clevs,cmap=cm.Purples,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
##cbar.set_label('K')
# add title
...
#print(x)
clevs = np.arange(0.,0.5,0.05)
cs = map.contourf(x,y,var5jja,clevs,cmap=cm.Purples,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
##cbar.set_label('K')
# add title
