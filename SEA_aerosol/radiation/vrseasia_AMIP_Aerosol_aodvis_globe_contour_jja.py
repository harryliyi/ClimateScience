...
outdir = "/scratch/d/dylan/harryli/cesm1/vrcesm/Analysis/vrseasia_AMIP_Aerosol/aod/"
...
varstr  = "550nm AOD"
var_res = "fv02"
fname1 = var_res+"_AOD_"+case1+".cam.h0.0001-0050.nc"
fname2 = var_res+"_AOD_"+case2+".cam.h0.0001-0050.nc"
fname3 = var_res+"_AOD_"+case3+".cam.h0.0001-0050.nc"
fname4 = var_res+"_AOD_"+case4+".cam.h0.0001-0050.nc"
fname5 = var_res+"_AOD_"+case5+".cam.h0.0001-0050.nc"
