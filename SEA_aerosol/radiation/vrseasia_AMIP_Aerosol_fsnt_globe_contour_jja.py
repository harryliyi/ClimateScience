...
outdir = "/scratch/d/dylan/harryli/cesm1/vrcesm/Analysis/vrseasia_AMIP_Aerosol/radiation/"

#set up variable names and file name
varname = 'FSNT'
varfname = "fsnt"
varstr  = "Net solar flux at top of atmosphere"
var_res = "fv02"
var_unit = 'W/m^2'
fname1 = var_res+"_SW_RADFLX_"+case1+".cam.h0.0001-0050.nc"
fname2 = var_res+"_SW_RADFLX_"+case2+".cam.h0.0001-0050.nc"
fname3 = var_res+"_SW_RADFLX_"+case3+".cam.h0.0001-0050.nc"
fname4 = var_res+"_SW_RADFLX_"+case4+".cam.h0.0001-0050.nc"
fname5 = var_res+"_SW_RADFLX_"+case5+".cam.h0.0001-0050.nc"
...
def getstats(var1,var2):
    ...
    varttest = np.divide(vardiff,np.sqrt(var1std**2/n1+var2std**2/n2))
...
#print(x)
clevs = np.arange(0.,325.,20)
cs = map.contourf(x,y,var1jja,clevs,cmap=cm.YlOrRd,alpha = 0.9,extend="both")
# add colorbar.
...
#print(x)
clevs = np.arange(0.,325.,20)
cs = map.contourf(x,y,var2jja,clevs,cmap=cm.YlOrRd,alpha = 0.9,extend="both")
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label(var_unit)
# add title
...
#print(x)
clevs = np.arange(0.,325.,20)
cs = map.contourf(x,y,var3jja,clevs,cmap=cm.YlOrRd,alpha = 0.9,extend="both")
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label(var_unit)
# add title
...
#print(x)
clevs = np.arange(0.,325.,20)
cs = map.contourf(x,y,var4jja,clevs,cmap=cm.YlOrRd,alpha = 0.9,extend="both")
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label(var_unit)
# add title
...
#print(x)
clevs = np.arange(0.,325.,20)
cs = map.contourf(x,y,var5jja,clevs,cmap=cm.YlOrRd,alpha = 0.9,extend="both")
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label(var_unit)
# add title
...
cbar.set_label(var_unit)
# add title
varglobe = np.mean(vardiff)
plt.title('Global mean = '+str(varglobe)+' '+var_unit,fontsize=10)
