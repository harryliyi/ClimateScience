...
def readobs_ERAinterim(varname, iniyear, endyear, varfname, frequency, latbounds, lonbounds, oceanmask=0):

    # set up directories dictionary
    dir = '/scratch/d/dylan/harryli/obsdataset/ERA_interim/'+varfname+'/'+frequency+'/'

    # set file name
    fname = 'era_interim_'+varname+'_'+frequency+'_19790101-20051231.nc'
...
def readobs_ERAinterim_3Dlevel(varname, iniyear, endyear, varfanme, frequency, plev, latbounds, lonbounds, oceanmask=0, **kwargs):

    # set if choose model levels
    ...
    # set up directories dictionary
    if model_level:
        dir = '/scratch/d/dylan/harryli/obsdataset/ERA_interim/'+varfanme+'/model_levels/'+frequency+'/'
    else:
        dir = '/scratch/d/dylan/harryli/obsdataset/ERA_interim/'+varfanme+'/pre_levels/'+frequency+'/'

    # set file name
    fname = 'era_interim_'+varfanme+'_197901-200512.nc'
