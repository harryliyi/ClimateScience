...
def readvrcesm(varname, iniyear, endyear, resolution, varfname, case, frequency, latbounds, lonbounds, oceanmask=0, **kwargs):
    ...
    fdir = '/scratch/d/dylan/harryli/cesm1/vrcesm/fields_archive/'+case+'/atm/hist/'
...
# read 3D variables
def readvrcesm_3D(varname, iniyear, endyear, resolution, varfname, case, frequency, latbounds, lonbounds, **kwargs):
...
def readvrcesm_3Dlevel(varname, iniyear, endyear, resolution, varfname, case, frequency, plev, latbounds, lonbounds, **kwargs):
