...
var1ts = np.mean(np.mean(var1,axis = 2),axis = 1)
var2ts = np.mean(np.mean(var2,axis = 2),axis = 1)
var3ts = np.mean(np.mean(var3,axis = 2),axis = 1)
var4ts = np.mean(np.mean(var4,axis = 2),axis = 1)
var5ts = np.mean(np.mean(var5,axis = 2),axis = 1)
...
plt.ylabel(varstr+" (K)")
plt.xlabel("Month")
plt.savefig(outdir+"vrseasia_aerosol_amip_"+varfname+"_mainlandSEA_monclim_allcases.pdf")
...
plt.ylabel(varstr+" (K)")
plt.xlabel("Month")
plt.savefig(outdir+"vrseasia_aerosol_amip_"+varfname+"_mainlandSEA_monclim_allforcings.pdf")
...
#print(x)
cs = map.contourf(x,y,var1ann,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case1+" Annual "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_case1.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var2ann,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case2+" Annual "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_case2.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var3ann,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case3+" Annual "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_case3.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var4ann,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case4+" Annual "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_case4.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var5ann,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case5+" Annual "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_case5.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_allforcings.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_GHGforcings.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_allaerosols.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_fastaerosol1.pdf")
...
# add title
plt.title("Aerosol fast response Annual "+varstr+" changes",fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_fastaerosol2.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_fastaerosol_check.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_slowaerosol1.pdf")
...
# add title
plt.title("Aerosol slow response Annual "+varstr+" changes",fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_slowaerosol2.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_annual_"+varfname+"_SEA_contour_slowaerosol_check.pdf")
