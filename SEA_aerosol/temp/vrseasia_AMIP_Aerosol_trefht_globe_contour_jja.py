...
outdir = "/scratch/d/dylan/harryli/cesm1/vrcesm/Analysis/vrseasia_AMIP_Aerosol/temp/"

#set up variable names and file name
varname = 'TREFHT'
varfname = "trefht"
varstr  = "2m Temperature"
var_unit = "K"
var_res = "fv02"
fname1 = var_res+"_TREFHT_"+case1+".cam.h0.0001-0050.nc"
fname2 = var_res+"_TREFHT_"+case2+".cam.h0.0001-0050.nc"
fname3 = var_res+"_TREFHT_"+case3+".cam.h0.0001-0050.nc"
fname4 = var_res+"_TREFHT_"+case4+".cam.h0.0001-0050.nc"
fname5 = var_res+"_TREFHT_"+case5+".cam.h0.0001-0050.nc"
...
def plotalldiff(lons,lats,res1,tt1,clim1,res2,tt2,clim2,res3,tt3,clim3,opt):
    ...
    ax1.set_title(r'$\Delta_{total}$ '+varname+', global mean='+str(round(np.mean(res1),4))+var_unit,fontsize=5,pad=3)
    ...
    map.drawcoastlines()
    map.drawcountries()
    parallels = np.arange(latbounds[0], latbounds[1],30)
    meridians = np.arange(lonbounds[0],lonbounds[1],60)
...
#    ax1.set_ylabel("Latitudes [degrees]",fontsize=5)
    ...
    ax2.set_title(r'$\Delta_{fast}$ '+varname+', global mean='+str(round(np.mean(res2),4))+var_unit,fontsize=5,pad=3)
    map = Basemap(projection='cyl',llcrnrlat=latbounds[0],urcrnrlat=latbounds[1],llcrnrlon=lonbounds[0],urcrnrlon=lonbounds[1],resolution = 'l')
    map.drawcoastlines()
    map.drawcountries()
    parallels = np.arange(latbounds[0], latbounds[1],30)
...
#    ax2.set_ylabel("Latitudes [degrees]",fontsize=5)
    ...
    ax3.set_title(r'$\Delta_{slow}$ '+varname+', global mean='+str(round(np.mean(res3),4))+var_unit,fontsize=5,pad=3)
    map = Basemap(projection='cyl',llcrnrlat=latbounds[0],urcrnrlat=latbounds[1],llcrnrlon=lonbounds[0],urcrnrlon=lonbounds[1],resolution = 'l')
    map.drawcoastlines()
    map.drawcountries()
    parallels = np.arange(latbounds[0], latbounds[1],30)
...
#    fig.subplots_adjust(right=0.7,hspace = 0.15)
    ...
    cbar.set_label(varstr+' ['+var_unit+']',fontsize=5,labelpad=0.7)

    # add title
    plt.suptitle("Aerosol Responses "+varstr+" changes",fontsize=10,y=0.95)
    if (opt==1):
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_globe_contour_response_with_siglev_aerosolsinone.pdf",bbox_inches='tight')
    else:
        plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_globe_contour_response_aerosolsinone.pdf",bbox_inches='tight')
...
var1 = fdata1.variables[varname][ (iniyear-1)*12 : (endyear)*12 , : , : ]
var2 = fdata2.variables[varname][ (iniyear-1)*12 : (endyear)*12 , : , : ]
var3 = fdata3.variables[varname][ (iniyear-1)*12 : (endyear)*12 , : , : ]
var4 = fdata4.variables[varname][ (iniyear-1)*12 : (endyear)*12 , : , : ]
var5 = fdata5.variables[varname][ (iniyear-1)*12 : (endyear)*12 , : , : ]

#################################################################################################
#select jja
var1jjats = np.zeros(((endyear-iniyear+1),len(lats),len(lons)))
var2jjats = np.zeros(((endyear-iniyear+1),len(lats),len(lons)))
var3jjats = np.zeros(((endyear-iniyear+1),len(lats),len(lons)))
var4jjats = np.zeros(((endyear-iniyear+1),len(lats),len(lons)))
var5jjats = np.zeros(((endyear-iniyear+1),len(lats),len(lons)))
...
map = Basemap(projection='cyl',lon_0=180,resolution = 'c')
map.drawcoastlines()
map.drawcountries()
parallels = np.arange(latbounds[0], latbounds[1],30)
meridians = np.arange(lonbounds[0],lonbounds[1],60)
...
#print(x)
cs = map.contourf(x,y,var1jja,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case1+" JJA "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_case1.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var2jja,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case2+" JJA "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_case2.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var3jja,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case3+" JJA "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_case3.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var4jja,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case4+" JJA "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_case4.pdf")
...
#print(lons[lonli:lonui+1])
#print(x)
cs = map.contourf(x,y,var5jja,cmap=cm.YlOrRd,alpha = 0.9)
# add colorbar.
cbar = map.colorbar(cs,location='bottom',pad="5%")
cbar.set_label('K')
# add title
plt.title(case5+" JJA "+varstr,fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_case5.pdf")
...
cs = map.contourf(x,y,vardiff,clevs,cmap=cm.coolwarm,alpha = 0.9,extend="both")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_allforcings.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_GHGforcings.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_allaerosols.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_fastaerosol1.pdf")
...
# add title
plt.title("Aerosol fast response JJA "+varstr+" changes",fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_fastaerosol2.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_fastaerosol_check.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_slowaerosol1.pdf")
...
# add title
plt.title("Aerosol slow response JJA "+varstr+" changes",fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_slowaerosol2.pdf")
...
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_slowaerosol_check.pdf")
...
cbar.ax.tick_params(labelsize=5)
cbar.set_label('K',fontsize=5)

# add title
fig.suptitle(varstr+" changes",fontsize=12)
plt.savefig(outdir+"vrseasia_aerosol_amip_jja_"+varfname+"_Globe_contour_forcingsin1.pdf")
