...
# define regions
reg_names = ['mainland SEA', 'Central Indian', 'South India', 'North India']
...
def plot_box(plot_data, labels, ylabel, title, fname, opt=0):
...
for ipercent in range(len(percentile_ranges)):
    ...
    for ireg in range(len(reg_names)):
        ...
        fname = 'vrseasia_aerosol_amip_jja_'+varfname+'_'+str(percentile)+'_th_extremes_'+reg_names[ireg]+'_box_exps_'+str(inimonth)+"to"+str(endmonth)
        ...
        fname = 'vrseasia_aerosol_amip_jja_'+varfname+'_'+str(percentile)+'_th_extremes_'+reg_names[ireg]+'_box_absolute_response_'+str(inimonth)+"to"+str(endmonth)
        title = 'Changes in '+varstr+' Rp'+str(percentile)+' over '+reg_names[ireg]
        plot_box(plot_data, labels, ylabel, title, outdir_percent+fname, opt=1)
        ...
        fname = 'vrseasia_aerosol_amip_jja_'+varfname+'_'+str(percentile)+'_th_extremes_'+reg_names[ireg]+'_box_relative_response_'+str(inimonth)+"to"+str(endmonth)
