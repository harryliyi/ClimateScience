...
outdir = "/scratch/d/dylan/harryli/cesm1/vrcesm/Analysis/vrseasia_AMIP_Aerosol/pre/extreme/prect_extreme_changes/JJA/15yr_test/heavy_counts_stats/"
...
for ireg in range(len(reg_names)):
    ...
    fname = var_res + '_vrseasia_aerosol_amip_jja_moderate_'+varfname+'_extremes_'+reg_names[ireg]+'_box_exps_'+str(inimonth)+"to"+str(endmonth)
    title = var_res + ' Aerosol experiments moderate '+varstr+' over '+reg_names[ireg]
    ...
    fname = var_res + '_vrseasia_aerosol_amip_jja_moderate_'+varfname+'_extremes_'+reg_names[ireg]+'_box_absolute_response_'+str(inimonth)+"to"+str(endmonth)
    title = var_res + ' Changes in moderate '+varstr+' over '+reg_names[ireg]
    plot_box(plot_data, labels, yticks, ylabel, title, outdir+fname)
    ...
    fname = var_res + '_vrseasia_aerosol_amip_jja_moderate_'+varfname+'_extremes_'+reg_names[ireg]+'_box_relative_response_'+str(inimonth)+"to"+str(endmonth)
    title = var_res + ' Relative Changes in moderate '+varstr+' over '+reg_names[ireg]
    plot_box(plot_data, labels, yticks, ylabel, title, outdir+fname)
    ...
    fname = var_res + '_vrseasia_aerosol_amip_jja_heavy_'+varfname+'_extremes_'+reg_names[ireg]+'_box_exps_'+str(inimonth)+"to"+str(endmonth)
    title = var_res + ' Aerosol experiments heavy '+varstr+' over '+reg_names[ireg]
    plot_box(plot_data, labels, yticks, ylabel, title, outdir+fname)
    ...
    fname = var_res + '_vrseasia_aerosol_amip_jja_heavy_'+varfname+'_extremes_'+reg_names[ireg]+'_box_absolute_response_'+str(inimonth)+"to"+str(endmonth)
    title = var_res + ' Changes in heavy '+varstr+' over '+reg_names[ireg]
    plot_box(plot_data, labels, yticks, ylabel, title, outdir+fname)
    ...
    fname = var_res + '_vrseasia_aerosol_amip_jja_heavy_'+varfname+'_extremes_'+reg_names[ireg]+'_box_relative_response_'+str(inimonth)+"to"+str(endmonth)
    title = var_res + ' Relative Changes in heavy '+varstr+' over '+reg_names[ireg]
    plot_box(plot_data, labels, yticks, ylabel, title, outdir+fname)
